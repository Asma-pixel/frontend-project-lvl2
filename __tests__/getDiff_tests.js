...
test('getDiff_True', () => {
  ...
  expect(testStr1).toBe(readFile('expectString2.txt'));
  expect(testStr2).toBe(readFile('expectString2.txt'));
  expect(testStr3).toBe(readFile('expectString2.txt'));
});
...
test('getDiff_False', () => {
  ...
  expect(testStr1).not.toBe(readFile('expectString2.txt'));
  expect(testStr2).not.toBe(readFile('expectString2.txt'));
});
